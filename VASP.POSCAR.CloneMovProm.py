...
#######################################################################################
#
#	Utiliza dos POSCAR como referencia de desplazamientos atómicos selectos
#	aplica el desplazamiento sobre átomos selectos de un tercer archivo
#
#	Útil para reposicionamiento de grupos adsorbidos y ajustes de altura
#	
#	Rev 1.5
#	Seba Godoy Gut - 06/Jul/2020	
#	Beca ANID - FOLIO 
#
#
#######################################################################################

print('\n Genera un movimiento promedio comparando grupos de átomos entre archivos POSCAR para luego ')
print(' aplicar ese movimiento a otro grupo de átomos en una copia de otro archivo.\n')
...
Compare=[]
iFile1 = input('    Nombre de geometría de referencia inicial : ')
Compare.append(GetList('comparar'))

iFile2 = input('    Nombre de geometría de referencia final   : ')
...
if not len(Compare[0])==len(Compare[1]):
	print('    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
	print('    !! Secuencias no tienen la misma cantidad  de átomos   !!')
	print('    !! necesito eso para vivir, adios mundo cruel          !!')
	print('    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n')
	quit()
print('\n    Secuencias comparables, abriendo archivos\n')
...
if not len(CoordSystem[0])==len(CoordSystem[1]):
	...
	print('    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n')
	quit()
else: print('    > Los modelos son apropiadamente comparables')
...
##  ------------------------------------------------------
	...
	################# Reescribe archivo ####################
	NewFile = iFile+'_Mov'
	print('    > Escribiendo nuevo archivo archivo : '+NewFile, end = ' ... ')
